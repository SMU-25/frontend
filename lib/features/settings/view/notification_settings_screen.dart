...
import 'package:team_project_front/features/settings/component/custom_notification_toggle_tile.dart';
...
class _NotificationSettingsScreenState
  ...
  final List<Map<String, dynamic>> notificationSettings = [
    {'title': '전체 알림 수신', 'subtitle': '케어 알림과 광고성 알림 모두 수신', 'value': false},
    {'title': '케어 알림 수신', 'subtitle': '아이 열 관리 알림만 수신', 'value': false},
    {
      'title': '마케팅 수신 동의',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: CustomAppbar(title: '알림 설정'),
      ),
      body: Padding(
