...
import 'package:team_project_front/features/homecam/component/no_home_cam_view.dart';
import 'package:team_project_front/features/homecam/model/home_cam.dart';
import 'package:team_project_front/features/homecam/view/create_home_cam.dart';
import 'package:team_project_front/features/homecam/view/delete_home_cam.dart';
import 'package:team_project_front/features/homecam/view/home_cam.dart';
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: _homeCams.isEmpty
                ...
                : [
                    ..._homeCams.map((cam) => _buildHomeCamCard(context, cam)),
                    const SizedBox(height: 16),
                    _buildAddButton(context),
                  ],
          ),
