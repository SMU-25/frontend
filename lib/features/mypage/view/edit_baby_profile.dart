...
import 'package:team_project_front/core/component/navigation_button.dart';
import 'package:team_project_front/core/component/yes_or_no_dialog.dart';
...
import 'package:team_project_front/features/mypage/component/illness_selctor.dart';
import 'package:team_project_front/features/mypage/component/profile_birth_input.dart';
import 'package:team_project_front/features/mypage/component/profile_body_info_input.dart';
import 'package:team_project_front/features/mypage/component/profile_gender_selector.dart';
import 'package:team_project_front/features/mypage/component/profile_image_with_add_icon.dart';
import 'package:team_project_front/features/mypage/component/profile_name_input.dart';
import 'package:team_project_front/features/mypage/component/seizure_history_selector.dart';
import 'package:team_project_front/features/mypage/models/profile_info.dart';
import 'package:team_project_front/features/mypage/utils/image_pick_handler.dart';
import 'package:team_project_front/features/mypage/utils/validators.dart';
import 'package:team_project_front/features/settings/component/custom_appbar.dart';
...
class EditBabyProfile extends StatefulWidget {
  ...
  const EditBabyProfile({required this.profileInfo, super.key});
      ...
      if (response.data['isSuccess'] == true) {
        ...
        if (context.mounted) {
          ...
          ScaffoldMessenger.of(
            context,
          ).showSnackBar(SnackBar(content: Text('아이 정보가 수정되었습니다.')));
        }
      } else {
            ...
            if (resp.data['isSuccess'] == true && resp.data['code'] == '204') {
              ...
              WidgetsBinding.instance.addPostFrameCallback((_) {
                navigatorKey.currentState?.pushAndRemoveUntil(
                  MaterialPageRoute(
                    builder: (_) => RootTab(initialTabIndex: 4),
                  ),
                  (route) => false,
                );
              });
            ...
            children: [
              ...
              IllnessSelector(
                ...
                onSelectionChanged: (newSet) =>
                    setState(() => selectedIllness = newSet),
              ),
              SizedBox(height: 40),
            ],
          ),
