...
import 'package:team_project_front/core/component/complete_dialog.dart';
...
class AddProfileSymptomsScreen extends StatefulWidget {
  ...
  const AddProfileSymptomsScreen({required this.profileInfo, super.key});

  @override
  State<AddProfileSymptomsScreen> createState() =>
      _AddProfileSymptomsScreenState();
}
...
class _AddProfileSymptomsScreenState extends State<AddProfileSymptomsScreen> {
  ...
  bool get isFormValid => seizure != null && selectedIllness.isNotEmpty;
        ...
        showDialog(
          ...
          builder: (_) => CompleteDialog(
            image: updatedProfileInfo.image != null
                ...
                : Icon(Icons.account_circle, size: 80, color: ICON_GREY_COLOR),
